...
`java -jar hpv-kite-1.0.3.jar <list-of-file-paths.fq.gz>`

For example:

`java -jar hpv-kite-1.0.3.jar  *.fq.gz`
...
> [!NOTE]
> Be sure that HPV-Kite _jar files_ (`hpv-kite-1.0.3.jar` and `pcj-5.3.3.jar`) are located in the same path as in the
> calling machine.
